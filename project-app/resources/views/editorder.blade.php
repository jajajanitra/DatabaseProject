                            ...
                            <form action="{{url('/order/update'.$order->id)}}" method="post">
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="orderNumber" value = "{{$order->orderNumber}}">                                    </div>
                                    @error('orderNumber')
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="requiredDate" value = "{{$order->requiredDate}}">
                                    </div>
                                    @error('requiredDate')
                                        <div>
                                            <span>{{$message}}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pointReceived" value="{{$order->pointReceived}}">
                                    </div>
                                    @error('pointReceived')
                                        <div>
                                            <span class="text-danger">{{$message}}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="couponNumber" value="{{$order->couponNumber}}">
                                    </div>
                                    @error('couponNumber')
                                        <div>
                                            <span class="text-danger">{{$message}}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="customerNumber" value="{{$order->customerNumber}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="paymentNumber" value="{{$order->paymentNumber}}">
                                    </div>
                                    @error('paymentNumber')
                                        <div>
                                            <span class="text-danger">{{$message}}</span>
